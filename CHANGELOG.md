...
- **v2-only docs and rules.** README, deployment/observability/SECRETS docs,
  NOTES, examples, and contributor guidance rewritten as v2-only with a support note
