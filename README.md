...
This creates `gcr-secret`, the pull secret the chart references by default. To
mirror images into your own registry instead, set `global.imageRegistry` and see
[Image catalog](https://docs.neuraltrust.ai/neuraltrust/deployment/images).
